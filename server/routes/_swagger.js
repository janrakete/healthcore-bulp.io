...
const options = {
  ...
  apis: ["./routes/info.js", "./routes/data.js", "./routes/devices.js", "./routes/scenarios.js", "./routes/care-insights.js"], // files containing annotations for the OpenAPI Specification
};
