    ...
    * Builds the prompt for report generation.
    ...
    buildReportPrompt(facts, language) {
        ...
        return [
            ...
            "Structure: 1) Brief overview, 2) Observed activity, 3) Notable findings, 4) Suggested observation.",
            "In observed activity, mention only report-relevant properties from propertyDailySummaries or propertySpikeFindings.",
            "Do not summarize total reading counts, room counts, or generic activity totals.",
            ...
            "Do not list generic averages as notable findings unless they indicate a clear anomaly or direct care relevance.",
