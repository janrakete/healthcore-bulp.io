  ...
  async connectedCallback() {
    this.innerHTML = `
      ...
      <ion-content class="ion-padding background-1">
        ...
        <ion-grid>
          <ion-row>
            <ion-col size="6"><ion-button class="selection" expand="block" href="/alerts"><div><div><ion-icon slot="start" name="analytics-sharp" size="large" color="primary"></ion-icon></div><div><ion-text>${window.Translation.get("PageAlertsHeadline")}</ion-text></div></div></ion-button></ion-col>
