    ...
    this.innerHTML = `
        ...
        <ion-content class="ion-padding background-1">
            <ion-grid>
                ...
                <ion-row>
                    <ion-col size="12"><ion-button class="selection" expand="block" href="/alert-rules"><ion-icon slot="start" name="options-sharp" size="large" color="primary"></ion-icon><ion-text>${window.Translation.get("AlertRulesTitle")}</ion-text></ion-button></ion-col>
                </ion-row>
            </ion-grid>
        </ion-content>
    `;
