  ...
  connectedCallback() {
    this.innerHTML = `
        ...
        <ion-content class="ion-padding">
            <ion-grid>
                <ion-row>
                    <ion-col size="6"><ion-button expand="block" href="/devices-add/zigbee"><div><div><ion-img src="../assets/icons/bridges/icon_zigbee_1.svg"></ion-img><ion-text>${window.Translation.get("Zigbee")}</ion-text></div></div></ion-button></ion-col>
