...
const appConfig = {
  ...
  CONF_anomalyDetectionThreshold: parseInt(process.env.CONF_anomalyDetectionThreshold),
  CONF_anomalyHistorySize       : parseInt(process.env.CONF_anomalyHistorySize),
};
