...
| 21 | **Care Insights publishes MQTT alert** | After triggering an unusual value (see above), subscribe to `server/care-insights` with an MQTT client. Verify the published message contains the insightID, type and title. |
